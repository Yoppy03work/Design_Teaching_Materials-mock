...
values
  (
    ...
    '{"bg":"#FFFFFF","text":"#1A1A1A","button":"#0B5FAE","buttonText":"#FFFFFF","accent":"#D87A00"}',
    '機能優先：最大限のコントラストと明快な色分けで「まず読めること」を最優先した。', 16.0, true
  ),
  (
    '00000000-0000-0000-0000-0000000000a2', null, 'sample', 'emotion', 'grandfather',
    '{"bg":"#FBF7EF","text":"#3A2E1F","button":"#8C5A2B","buttonText":"#FFFFFF","accent":"#C24914"}',
    '感情優先：セピア調の温かみで家族写真の思い出を引き立てた。文字コントラストはAAを確保。', 9.5, true
  ),
  (
    '00000000-0000-0000-0000-0000000000a3', null, 'sample', 'dialogue', 'grandfather',
    '{"bg":"#F2F5F7","text":"#16242E","button":"#1C6E8C","buttonText":"#FFFFFF","accent":"#E0A100"}',
    '対話優先：祖父に何度か見せ、青系の落ち着きと暖色アクセントの組み合わせに調整した。', 11.0, true
  )
on conflict (id) do nothing;
